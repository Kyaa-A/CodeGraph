...
const LOGOS: Record<string, React.ReactNode> = {
  python: (
    <svg viewBox="0 0 256 255" className="h-8 w-8">
  ...
  react: (
    <svg viewBox="0 0 256 228" className="h-8 w-8">
  ...
  java: (
    <svg viewBox="0 0 256 346" className="h-8 w-8">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {["python", "javascript", "java", "sql", "react", "typescript"].map((lang) => {
              ...
              return (
                ...
                >
                  <div className="h-5 w-5 shrink-0">{LOGOS[lang]}</div>
                  {name}
                </Link>
              );
            })}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
              {cat.languages.map((l) => {
                ...
                return (
                  ...
                  >
                    <div className="shrink-0">{LOGOS[l.lang]}</div>
