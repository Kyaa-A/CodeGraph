...
const LANGUAGES = [
  ...
  },
  {
    lang: "typescript",
    name: "TypeScript",
    description: "Type-safe JavaScript. Interfaces, generics, utility types, React integration, and compiler config.",
    color: "bg-blue-600",
    icon: "🔷",
  },
  {
    lang: "react",
    name: "React",
    description: "Build modern UIs. Components, hooks, state management, routing, and Next.js fundamentals.",
    color: "bg-sky-500",
    icon: "⚛️",
  },
  {
    lang: "html-css",
    name: "HTML & CSS",
    description: "Web foundations. Semantic HTML, Flexbox, Grid, animations, responsive design, and Tailwind CSS.",
    color: "bg-orange-500",
    icon: "🌐",
  },
  {
  ...
  },
  {
    lang: "go",
    name: "Go",
    description: "Fast, simple, concurrent. Goroutines, channels, interfaces, modules, and HTTP servers.",
    color: "bg-cyan-600",
    icon: "🔵",
  },
  {
    lang: "rust",
    name: "Rust",
    description: "Safe systems programming. Ownership, borrowing, lifetimes, traits, async, and concurrency.",
    color: "bg-orange-700",
    icon: "🦀",
  },
  {
    lang: "c",
    name: "C",
    description: "The foundation of programming. Pointers, memory management, structs, and file I/O.",
    color: "bg-slate-600",
    icon: "⚙️",
  },
  {
    lang: "cpp",
    name: "C++",
    description: "Powerful OOP and systems language. Classes, templates, STL, smart pointers, and more.",
    color: "bg-indigo-600",
    icon: "🔧",
  },
  {
    lang: "csharp",
    name: "C#",
    description: "Modern .NET development. LINQ, generics, async/await, collections, and OOP patterns.",
    color: "bg-violet-600",
    icon: "💜",
  },
  {
    lang: "php",
    name: "PHP",
    description: "Server-side web development. Forms, sessions, OOP, PDO database access, and more.",
    color: "bg-indigo-500",
    icon: "🐘",
  },
  {
    lang: "nodejs",
    name: "Node.js",
    description: "Server-side JavaScript. Express, REST APIs, file system, streams, and database integration.",
    color: "bg-green-600",
    icon: "🟢",
  },
  {
