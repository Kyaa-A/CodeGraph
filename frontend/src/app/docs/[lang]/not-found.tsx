  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Language not found</h1>
        <p className="text-slate-500 mb-8">This language doesn't exist or isn't supported yet.</p>
        <Link
          href="/docs"
