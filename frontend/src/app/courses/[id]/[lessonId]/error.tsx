  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Failed to load lesson</h1>
        <p className="text-slate-500 mb-8">Something went wrong loading this lesson. Please try again.</p>
