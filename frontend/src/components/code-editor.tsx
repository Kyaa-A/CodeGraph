...
export function CodeEditor({
  ...
  return (
    <div className="flex flex-col h-full bg-[#1e1e1e] rounded-2xl overflow-hidden border border-white/10">
      {/* Toolbar */}
      <div className="flex items-center justify-between px-2 sm:px-4 py-2 bg-[#2d2d2d] border-b border-white/10">
        <div className="flex items-center gap-2">
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-2 sm:px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-xs sm:text-sm text-gray-300 transition-colors"
            >
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Button
            ...
            disabled={isWorking}
            size="sm"
            className="bg-white/10 hover:bg-white/15 text-gray-200 rounded-lg px-2.5 sm:px-4 gap-1.5 sm:gap-2"
          >
            {running ? (
              <>
